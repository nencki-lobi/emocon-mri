...
gr.add_argument('--participant_label', nargs='+')
gr.add_argument('--participant_file', help='Text file, 1 subject per line')
...
if args.participant_label is not None:
    ...
    with open(args.participant_file) as f:
        codes = [x.rstrip().capitalize() for x in f.readlines()]
else:
