...
McGill Friendship Questionnaire score (Friend group only, both demonstrators and observers):

```{r}
df %>%
	filter(df[(role == "OBS" & CONT_contingency == "YES" & group == "friend") | (role == "DEM" & group = "friend")]) #%>%
