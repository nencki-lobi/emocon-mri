...
boxplot_ofl <- ws_avg_ofl%>%
  ...
  #           add = "jitter", width = 0.7, add.params = list(size = .8, alpha = .35),
  #           color = "thing", palette = c("#D55E00", "#E69F00", "#0072B2", "#56B4E9"), legend = c(0.75,0.9),
  #           xlab = FALSE, legend.title = "") +
  #labs(y = "amplitude (arb. unit)") +
  #theme(axis.text.x=element_blank(), axis.ticks.x=element_blank())

  ggbarplot (x = "thing", y = "m_amplitude", order = c("friend US", "friend no US", "stranger US", "stranger no US"),
             add = c("mean_ci", "jitter"), width = 0.7, add.params = list(size = .8, alpha = .35),
             color = "thing", palette = c("#D55E00", "#E69F00", "#0072B2", "#56B4E9"), legend = c(0.75,0.9),
             xlab = FALSE, legend.title = "") +
  labs(y = "amplitude (arb. unit)") +
  theme(axis.text.x=element_blank(), axis.ticks.x=element_blank())
...
boxplot_de <- ws_avg_de%>%
  ...
  ggbarplot (x = "thing", y = "m_amplitude", order = c("friend CS+", "friend CS-", "stranger CS+", "stranger CS-"),
             add = c("mean_ci", "jitter"), width = 0.7, add.params = list(size = .8, alpha = .35),
             color = "thing", palette = c("#D55E00", "#E69F00", "#0072B2", "#56B4E9"), legend = c(0.3,0.9),
             xlab = FALSE, legend.title = "") +
  labs(y = "amplitude (arb. unit)") +
...
ggexport(
    scr_boxplot_4colors,
    filename = file.path(fig_dir, "scr_barplot_4colors_anova.png"),
