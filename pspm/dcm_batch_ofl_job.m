%-----------------------------------------------------------------------
% Job saved on 28-May-2020 10:38:39 by cfg_util (rev $Rev: 380 $)
% pspm PsPM - Unknown
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.modelfile = '<UNDEFINED>';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.outdir = '<UNDEFINED>';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.chan.chan_def = 0;
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.datafile = '<UNDEFINED>';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.timing.timingfile = '<UNDEFINED>';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.condition(1).name = 'CS plus reinforced';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.condition(1).index = '<UNDEFINED>';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.condition(2).name = 'CS plus nonreinforced';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.condition(2).index = '<UNDEFINED>';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.condition(3).name = 'CS minus';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.condition(3).index = '<UNDEFINED>';
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.session.missing.epochs.epochfile = '<UNDEFINED>';
...
matlabbatch{1}.pspm{1}.first_level{1}.scr{1}.dcm.disp_options.dispwin = 1;
