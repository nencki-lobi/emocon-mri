...
model_dirs = cellstr(...
    spm_select(...
        'FpList', ...
        fullfile(spm_out_dir, 'allsub-halfdata', 'level1_de'), ...
        'dir', ...
        'sub-.*task-de' ...
        ) ...
    );
...
level2dir = cellstr(fullfile(spm_out_dir, 'allsub-halfdata', 'level2'));
