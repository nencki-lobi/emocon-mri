...
level1_con02 = fullfile(spm_out_dir, 'modulation', 'level1_tmod1',...
    'sub-%s_task-ofl', 'con_0002.nii'); % us > noUS
level1_con05 = fullfile(spm_out_dir, 'modulation', 'level1_tmod1',...
...
jobfile = {'second_level_pmod_groups_job.m'};  % same as pmod & de
