...
% level 1 files path spec (con 0002 is cs+ tmod param)
level1spec = fullfile(spm_out_dir, 'modulation', 'level1_tmod1',...
    'sub-%s_task-de', 'con_0002.nii');

% build the inputs for the batch
inputs{1, 1} = fullfile(level2dir, 'group_tmod1_de_plus');
