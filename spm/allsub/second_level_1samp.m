...
jobfile = {'/Users/michal/Documents/emocon_mri_study/spm/allsub/second_level_1samp_job.m'};
...
for crun = 1:nrun
    ...
    inputs{4, crun} = MATLAB_CODE_TO_FILL_INPUT; % Contrast Manager: Name - cfg_entry
end
spm('defaults', 'FMRI');
