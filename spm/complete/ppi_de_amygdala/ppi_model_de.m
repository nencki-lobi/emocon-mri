...
task = "de";                            % name of task
ppi_file = "PPI_amygdalaxCS.mat";       % name of PPI file
ppi_name = "PPI_de_amygdalaxCS";        % name of output folder
psych_name = "CS plus - CS minus";      % name for PPI.P regressor
physio_name = "amygdala BOLD";          % name for the PPI.Y regressor
ctr_name = "amygdala PPI Interaction";  % name for the [1 0 0] contrast
...
for crun = 1:nrun
    ...
    inputs{2, crun} = Inf; % Expand image frames: Frames - cfg_entry
