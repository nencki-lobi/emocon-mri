...
task = "ofl";                       % task name
ppi_file = "PPI_rpSTSxUS.mat";       % name of PPI file
ppi_name = "PPI_ofl_rpSTSxUS";       % name of output folder
psych_name = "US - noUS";           % name for PPI.P regressor
physio_name = "rpSTS BOLD";          % name for the PPI.Y regressor
ctr_name = "rpSTS PPI Interaction";  % name for the [1 0 0] contrast
