%-----------------------------------------------------------------------
% Job saved on 21-May-2021 12:57:43 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
...
matlabbatch{2}.spm.stats.fmri_spec.sess.regress(1).name = '<UNDEFINED>';
matlabbatch{2}.spm.stats.fmri_spec.sess.regress(1).val = '<UNDEFINED>';
matlabbatch{2}.spm.stats.fmri_spec.sess.regress(2).name = '<UNDEFINED>';
matlabbatch{2}.spm.stats.fmri_spec.sess.regress(2).val = '<UNDEFINED>';
matlabbatch{2}.spm.stats.fmri_spec.sess.regress(3).name = '<UNDEFINED>';
...
matlabbatch{4}.spm.stats.con.consess{1}.tcon.weights = '<UNDEFINED>';
