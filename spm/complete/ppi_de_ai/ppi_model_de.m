...
ppi_file = "PPI_AIxCS.mat";       % name of PPI file
ppi_name = "PPI_de_AIxCS";        % name of output folder
psych_name = "CS plus - CS minus";      % name for PPI.P regressor
physio_name = "AI BOLD";          % name for the PPI.Y regressor
ctr_name = "AI PPI Interaction";  % name for the [1 0 0] contrast
